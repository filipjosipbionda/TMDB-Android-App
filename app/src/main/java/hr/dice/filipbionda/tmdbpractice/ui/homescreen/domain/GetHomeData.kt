...
private fun ContentType.getContentPath(): String {
    return when(this) {
        ContentType.MOVIE -> ApiContentRoutes.MOVIES
        ContentType.SERIES -> ApiContentRoutes.SERIES
        ContentType.ANIME -> ApiContentRoutes.ANIME
        ContentType.SOAPS -> ApiContentRoutes.SOAPS
        ContentType.SPECIALS -> ApiContentRoutes.SPECIALS
    }
}
